      ...
      >
        ...
        <div className="mt-6 flex items-center justify-end gap-3">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg bg-brand px-4 py-2 text-sm font-semibold text-white transition hover:bg-brand-dark disabled:opacity-50 disabled:cursor-not-allowed"
          >
                  ...
                  <div className="flex items-center justify-end gap-3">
                    {a.status === "completed" && (
                      <button
                        ...
                        disabled={printingPhone === a.phone}
                        className="inline-flex items-center gap-1.5 rounded-lg border border-slate-300 px-2.5 py-1 text-xs font-medium text-ink transition hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        {printingPhone === a.phone ? <ButtonSpinner /> : "🖨️"} {printingPhone === a.phone ? "Printing…" : "Print Prescription"}
                      </button>
                    )}
                    {a.status === "pending" && (
                      <>
                        <button
                          ...
                          disabled={pending}
                          className="inline-flex items-center gap-1.5 rounded-lg bg-brand px-2.5 py-1 text-xs font-semibold text-white transition hover:bg-brand-dark disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                        ...
                        <button
                          ...
                          disabled={pending}
                          className="rounded-lg border border-slate-300 px-2.5 py-1 text-xs font-medium text-ink transition hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          Reschedule
                        </button>
                        <button
                        ...
                        {isDoctor !== false && (
                          <button
                            ...
                            disabled={pending}
                            className="text-xs font-medium text-red-600 transition hover:text-red-700 disabled:opacity-50 disabled:cursor-not-allowed"
                          >
                            Delete
                          </button>
                        )}
